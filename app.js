...
const batchRouter=require("./app/router/batchRouter")
app.use("/batch",batchRouter)
const EnrollmentRouter=require("./app/router/enrollementRouter")
app.use("/enrollement",EnrollmentRouter)
const ExamRouter=require("./app/router/examRouter")
